...
Backend Java engineer building event-driven microservices at scale. Currently working on large-volume logistics platforms and building AI-assisted developer tooling.

- 🌍 Based in Liverpool, UK
- 🔧 Spring Boot, Kafka, MongoDB — production systems processing millions of events
- 🤖 Building Claude skills for developer productivity (release automation, test generation, architecture documentation)
